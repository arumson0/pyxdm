...
# USAGE:
The compiler adds the parrotxdm executable to your path. You may want to copy this to your .bashrc (Sorry windows users, you're on your own.)

`parrotxdm input.yaml`
